...
return new class extends Migration
{
    ...
    {
        Schema::create('solicitud_servicio_documentos', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('tipo')->default('resultado');
            $table->string('titulo');
    ...
    {
        Schema::dropIfExists('solicitud_servicio_documentos');
    }
};

...
<head>
    ...
    <title>Página no encontrada | TramitaNet</title>
    ...
    <main class="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-12 sm:px-6">
        ...
        <section class="relative w-full max-w-3xl rounded-3xl border border-white/10 bg-white/5 p-6 text-center shadow-2xl backdrop-blur sm:p-10">
            ...
            <a
                ...
                class="mx-auto mb-8 inline-flex items-center justify-center"
            >
                <img
            ...
            <h1 class="mt-4 text-6xl font-black tracking-tight text-white sm:text-8xl">
                404
            </h1>
            ...
            <p class="mx-auto mt-2 max-w-xl text-sm leading-6 text-slate-400 sm:text-base">
                Puedes regresar al inicio de TramitaNet o consultar el estado de tu trámite mediante tu folio.
            </p>

            <div class="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
                <a
                    href="{{ route('tramitanet.index') }}"
                    class="inline-flex items-center justify-center rounded-xl bg-orange-500 px-6 py-3 text-sm font-black text-white shadow-lg transition hover:bg-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-300"
                >
                    Ir al inicio
                </a>
                ...
                <a
                    ...
                    class="inline-flex items-center justify-center rounded-xl border border-blue-400/40 bg-blue-500/10 px-6 py-3 text-sm font-black text-blue-200 transition hover:border-blue-300 hover:bg-blue-500/20 focus:outline-none focus:ring-2 focus:ring-blue-300"
                >
                    Consultar folio
                </a>
            </div>

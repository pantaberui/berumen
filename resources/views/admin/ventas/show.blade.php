<x-app-layout>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm rounded-lg p-6 font-mono text-sm" id="ticket" style="max-width:600px;margin:0 auto;">
                ...
                <div class="border-t border-dashed pt-4 space-y-2">
                    <div class="flex justify-between">
                        ...
                        <span class="font-bold">#{{ str_pad($venta->id, 6, '0', STR_PAD_LEFT) }}</span>
                    </div>
                    <div class="flex justify-between">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="capitalize">{{ $venta->tipo_pago }}</span>
                    </div>
                    @if($venta->estatus === 'cancelada')
                    <div class="flex justify-between text-red-600 font-medium">
                        <span>ESTATUS:</span><span>CANCELADA</span>
                    </div>
                    @endif
                </div>
                    ...
                    <table class="w-full text-xs">
                        <thead>
                            <tr class="text-gray-500">
                                <td class="pb-2">Descripción</td>
                                <td class="pb-2 text-center">Cant.</td>
                                <td class="pb-2 text-right">Precio</td>
                                <td class="pb-2 text-right">Desc.</td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="py-1">{{ $detalle->producto->descripcion }}</td>
            ...
            <div id="modal_correo" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
                <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-sm mx-4">
                    ...
                    @endif
                    <form action="{{ route('admin.ventas.enviar-correo', $venta) }}" method="POST">
                        @csrf
                ...
                <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-sm mx-4">
                    ...
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <input type="text" id="whatsapp_numero"
                               value="{{ preg_replace('/\D/', '', $venta->cliente?->celular ?? $venta->cliente?->telefono ?? '') }}"
    ...
    <script>
        function imprimirTicket() {
            ...
            ventana.document.write(`<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Ticket Venta</title>
            <style>
                ...
                .text-gray-500{color:#6b7280;}.text-gray-600{color:#4b5563;}.text-gray-400{color:#9ca3af;}
                ...
                .mb-4{margin-bottom:16px;}.space-y-2>*+*{margin-top:8px;}
                .space-y-1>*+*{margin-top:4px;}.pt-2{padding-top:8px;}.italic{font-style:italic;}
                .capitalize{text-transform:capitalize;}.w-full{width:100%;}
                table{width:100%;border-collapse:collapse;}.py-1{padding-top:4px;padding-bottom:4px;}
                .pb-2{padding-bottom:8px;}.text-right{text-align:right;}.text-center{text-align:center;}
        ...
        function enviarWhatsApp() {
            ...
            const datos = {
                ...
                cliente: @json($venta->cliente_nombre),

                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-sm text-gray-700">
                                <span class="font-mono text-xs text-gray-400">{{ $compra->producto->clave }}</span>
                                {{ $compra->producto->descripcion }}
                            </td>
                            <td class="px-4 py-3 text-sm text-gray-500">{{ $compra->cantidad }}</td>
                            <td class="px-4 py-3 text-sm text-gray-500">${{ number_format($compra->precio_compra, 2) }}</td>
                            ...
                            <td class="px-4 py-3 text-sm text-gray-500">{{ $compra->fecha_hora_compra?->format('d/m/Y H:i') }}</td>
                        ...
                        @empty
                        <tr>
                            <td colspan="8" class="px-6 py-8 text-center text-gray-400">No hay compras en el rango seleccionado.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
